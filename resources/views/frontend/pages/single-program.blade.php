            ...
            <div class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-6">
                    ...
                    <div class="py-8 lg:pe-8">
                        <div class="space-y-5 lg:space-y-8">
                            ...
                            <div class="flex items-center gap-x-5">
                                ...
                                <!-- Button -->
                                <div class="relative inline-flex mb-1.5 lg:mb-2 hs-dropdown">
                                    <button
                                        type="button"
                                        id="blog-article-share-dropdown"
                                        class="flex items-center text-sm text-gray-500 hs-dropdown-toggle gap-x-2 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                    >
                                        <svg
                                            class="flex-shrink-0 size-4"
                                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="grid gap-3 lg:grid-cols-2">
                                    <div class="grid grid-cols-2 gap-3 lg:grid-cols-1">
                                        <figure class="relative w-full h-60">
                                            <img
                                                class="absolute top-0 object-cover size-full start-0 rounded-xl"
                            ...
                            <div class="space-y-3">
                                ...
                                <p class="text-lg text-gray-800 dark:text-neutral-200">
                                    ...
                                    everyone to try Preline and explore how transformative open communication can be.
                                    Now you can have a team of one or two designers and unlimited spectators (think PMs,
                                    management, marketing, etc.) share work and explore the design process earlier.
                                </p>
                            </div>

                            <ul
                                class="space-y-5 text-lg text-gray-800 list-disc list-outside ps-5 dark:text-neutral-200"
                            >
                                <li class="ps-2">
                                    Preline allows us to collaborate in real time and is a really great way for
                                    leadership on the team to stay up-to-date with what everybody is working on,"
                                    <a
                                        class="font-medium text-blue-600 decoration-2 hover:underline dark:text-blue-500"
                                        href="#"
                                    >
                ...
                >
                    <div class="sticky top-0 py-8 start-0 lg:ps-8">
                        ...
                        >
                            <h1 class="text-xl font-semibold md:text-2xl lg:text-3xl">Program Lainnya</h1>
                        </div>
                        <!-- End Avatar Media -->
                        ...
                        <div class="space-y-6">
                            ...
                            <a class="flex items-center group gap-x-6" href="#">
                                ...
                                <div class="relative flex-shrink-0 overflow-hidden rounded-lg size-20">
                                    <img
                                        class="absolute top-0 object-cover rounded-lg size-full start-0"
